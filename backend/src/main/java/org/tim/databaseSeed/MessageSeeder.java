...
public class MessageSeeder {
    ...
    public Map<String, Message> initMessages(Map<String, Project> projects) {
        ...
        Message messageM1 = new Message("welcome1", "Groceries you’ll love, perfectly delivered.", projects.get("projectP1").getId());
        ...
        Message messageM2 = new Message("welcome2", "Low Price Promise.", projects.get("projectP1").getId());
        ...
        Message pricing = new Message("pricing", "Pricing", projects.get("projectP1").getId());
        pricing.setDescription("Website title.");
        messages.put("pricing", messageRepository.save(pricing));
        Message signUp = new Message("signUp", "Sign up", projects.get("projectP1").getId());
        signUp.setDescription("Sign up button");
        messages.put("signUp", messageRepository.save(signUp));
        Message ocadoTechnology = new Message("ocadoTechnology", "Ocado Technology", projects.get("projectP1").getId());
        ocadoTechnology.setDescription("Company name");
        messages.put("ocadoTechnology", messageRepository.save(ocadoTechnology));
        Message featuresNav = new Message("featuresNav", "Features", projects.get("projectP1").getId());
        ...
        Message enterpriseNav  = new Message("enterpriseNav", "Enterprise ", projects.get("projectP1").getId());
        ...
        Message supportNav  = new Message("supportNav", "Support ", projects.get("projectP1").getId());
        supportNav.setDescription("Navbar link to see help view.");
        messages.put("supportNav", messageRepository.save(supportNav));
        Message pricingNav  = new Message("pricingNav", "Pricing ", projects.get("projectP1").getId());
        ...
        Message freeCard  = new Message("freeCard", "Free", projects.get("projectP1").getId());
        ...
        Message maxFreeUsers = new Message("maxFreeUsers", "10 users included", projects.get("projectP1").getId());
        ...
        Message maxFreeMemoryLimit = new Message("maxFreeMemoryLimit", "2 GB of storage", projects.get("projectP1").getId());
        ...
        Message freeEmailSupport = new Message("freeEmailSupport", "Email support", projects.get("projectP1").getId());
        ...
        Message freeHelpCenter = new Message("freeHelpCenter", "Help center access", projects.get("projectP1").getId());
        ...
        Message signUpToAccess = new Message("signUpToAccess", "Sign up for free", projects.get("projectP1").getId());
        ...
        Message proCard = new Message("proCard", "Pro", projects.get("projectP1").getId());
        proCard.setDescription("Information about product type.");
        messages.put("proCard", messageRepository.save(proCard));
        Message maxProUsers = new Message("maxProUsers", "20 users included", projects.get("projectP1").getId());
        ...
        Message maxProMemoryLimit = new Message("maxProMemoryLimit", "10 GB of storage", projects.get("projectP1").getId());
        ...
        Message proEmailSupport = new Message("proEmailSupport", "Priority email support", projects.get("projectP1").getId());
        ...
        Message proHelpCenter = new Message("proHelpCenter", "Help center access", projects.get("projectP1").getId());
        ...
        Message getStarted = new Message("getStarted", "Get started", projects.get("projectP1").getId());
        ...
        Message enterpriseCard = new Message("enterpriseCard", "Enterprise", projects.get("projectP1").getId());
        ...
        Message maxEnterpriseUsers = new Message("maxEnterpriseUsers", "30 users included", projects.get("projectP1").getId());
        ...
        Message maxEnterpriseMemoryLimit = new Message("maxEnterpriseMemoryLimit", "15 GB of storage", projects.get("projectP1").getId());
        ...
        Message enterpriseEmailSupport = new Message("enterpriseEmailSupport", "Phone and email support", projects.get("projectP1").getId());
        ...
        Message enterpriseHelpCenter = new Message("enterpriseHelpCenter", "Help center access", projects.get("projectP1").getId());
        ...
        Message contactUs = new Message("contactUs", "Contact us", projects.get("projectP1").getId());
        ...
        Message messageM3 = new Message("business1", "Opracowaliśmy i stosujemy unikalny model biznesowy, który mocno nas pozycjonuje, " +
                "ponieważ coraz więcej konsumentów decyduje się na zakupy w Internecie.", projects.get("projectP2").getId());
        ...
        Message messageM4 = new Message("business2", "Naszym strategicznym celem jest dostosowanie interesów naszych klientów," +
                " inwestorów i innych interesariuszy do zapewnienia długoterminowej wartości dla akcjonariuszy.", projects.get("projectP2").getId());
        ...
        Message message1ForManyLocales = new Message("message1", "Short one.", projects.get("projectP3").getId());
		messageM4.setDescription("M is short.");
		messages.put("message1ForManyLocales", messageRepository.save(message1ForManyLocales));
        Message message2ForManyLocales = new Message("message2", "Looooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong one.", projects.get("projectP3").getId());
